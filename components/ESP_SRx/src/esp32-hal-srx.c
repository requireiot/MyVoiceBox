 ...
 * 
 * modifications marked BW are Copyright(C)2025 Bernd Waldmann, MIT license
 */
#include "sdkconfig.h"
...
// BW
 ...
 #define PCM_TOTAL_CH_NUM 3
 #define PCM_REF_NUM 1
#else
 #define PCM_TOTAL_CH_NUM 2
...
static srx_data_t *g_sr_data = NULL;
...
esp_err_t srx_start(
  ...
  g_sr_data = heap_caps_calloc(1, sizeof(srx_data_t), MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT);
